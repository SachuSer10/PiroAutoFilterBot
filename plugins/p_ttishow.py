...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            return
        buttons = [[
            InlineKeyboardButton('⚙️ ꜱᴜᴩᴩᴏʀᴛ ⚙️', url=f"https://t.me/{SUPPORT_CHAT}"),
            InlineKeyboardButton('⚡ ᴜᴩᴅᴀᴛᴇꜱ ⚡', url="https://t.me/MovieFlix_tg")
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def disable_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('⚙️ ꜱᴜᴩᴩᴏʀᴛ ⚙️', url=f"https://t.me/{SUPPORT_CHAT}"),
            InlineKeyboardButton('⚡ ᴜᴩᴅᴀᴛᴇꜱ ⚡', url="https://t.me/piroxbots")
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await bot.send_message(
            chat_id=chat_, 
